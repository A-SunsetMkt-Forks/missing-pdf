...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=.75\textwidth]{assets/software/Searching_Revit_tutorials_on_bilibili.png}
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=.57\textwidth]{assets/software/Ansys.png}
  \caption{Ansys 英语教程}
  \label{fig:Ansys}
\end{figure}
